...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    assert.deepStrictEqual(createMenu(meuMenu).fetchMenu(), meuMenu);
    ...
    let objetoRetornado = createMenu(meuMenu);
    objetoRetornado.order('coxinha');
    ...
    objetoRetornado = createMenu(meuMenu);
    objetoRetornado.order('coxinha');
    objetoRetornado.order('agua');
    objetoRetornado.order('coxinha');
    ...
    assert.strictEqual(parseFloat(objetoRetornado.pay().toPrecision(4)), 12.87);
